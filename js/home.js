  ...
  const secoes = [
    ...
    },
    {
      ...
      tecnologias: [
        ...
        ["Plotly", "plotly/plotly-original.svg"],
      ],
    },
    {
...
const translations = {
  pt: {
    static: {
      ...
      hab: {
        ...
        criadoCom: "Este portfolio foi criado usando",
        grid: {
          linguagens: {
            titulo: "Linguagens",
  ...
  en: {
    static: {
      ...
      hab: {
        h1Hab: "My Skills",
        titulo1: "Languages & frameworks",
        titulo2: "Databases",
        titulo3: "Tools & software",
        criadoCom: "This portfolio was built using",
        grid: {
          linguagens: {
            titulo: "Languages",
